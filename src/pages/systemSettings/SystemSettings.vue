            ...
            <div class="section-card mb-11 !px-0 !pb-0 mt-3.5">
                ...
                <div class="pb-20 pl-6.5">
                    ...
                    <button
                      ...
                      v-if="!isRequest"
                      class="w-[264px] h-12 rounded-xl border border-white-02 mt-3.5 text-blue-05 font-bold text-[15px] leading-6"
                    >
                ...
                <div class="section-card !px-0 !m-0 h-full">
                    <h2 class="!mb-5 mt-1.5 px-3 justify-between">
                        <div class="inline-flex items-center">
                            <span class="!bg-orange-02 ml-0.5"></span>Request Delegation
                        </div>
                        <button
