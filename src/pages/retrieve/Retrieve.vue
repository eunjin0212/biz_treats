    ...
    <main class="bg-white-17 flex w-[1228px] mx-auto">
        ...
        <section class="w-[calc(100%-266px)] max-w-[970px] flex flex-col">
            <div class="section-card !px-0 mb-11 mt-4.5">
                ...
                >
                    <span class="bg-blue-05 rounded-lg mr-2.5">
                        <PrevPageSvg />
                    </span>
                ...
                <div class="text-center">
                    <div class="flex items-center mb-3 flex-nowrap">
                        ...
                        <span
                          class="w-[66px] inline-block font-semibold text-blue-05 text-sm leading-6 text-center tracking-wide mx-[60px]"
                        >
                            Massage
                        </span>
                        <hr class="flex-grow border-white-10" />
                    ...
                    <div class="flex items-center justify-end pt-3 pr-6 gap-2">
                        ...
                        <button
                          ...
                          :class="tab !== 'Retrieve' ? 'bg-main hover:bg-blue-06' : 'bg-red-06 hover:bg-red-07'"
