...
import TransferSvg from '@/assets/icons/TransferSvg.vue';
...
export default {
    ...
    computed: {
        matchPath: () => {
            return (path) => window.location.pathname.includes(path)
        },
        ...
        <section class="w-[calc(100%-266px)] max-w-[970px] flex flex-col">
            <div class="section-card !px-0 mb-11 mt-4.5">
                <h2 class="relative w-[100%_-_12px] px-3">
                    ...
                    <a
                      href="/retrieve"
                      class="absolute inline-flex items-center gap-1.5 bg-blue-05 rounded-lg right-6 text-white-19 font-bold text-[15px] leading-6 pl-6 pr-7 py-3"
                    >
                        <TransferSvg />
                        Transfer/Retrieve
                    </a>
